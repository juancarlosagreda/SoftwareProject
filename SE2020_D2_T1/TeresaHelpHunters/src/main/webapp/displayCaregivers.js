function displayCaregivers() {
	...
	send.setAttribute("href","caregiverProfile?firstname=" + caregiverDataItem[i].firstname +"&lastname=" + caregiverDataItem[i].lastname +"&caregiverID=" +caregiverDataItem[i].caregiverID +"&hourlyrate=" +caregiverDataItem[i].hourlyrate +"&description=" +caregiverDataItem[i].description);

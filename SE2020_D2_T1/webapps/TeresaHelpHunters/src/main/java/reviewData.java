...
public class reviewData {
    ...
    reviewData (int employmentID, String firstname, String lastname, int numberofstars, String comment, Date ratedate ) {
	...
	reviewData (int employmentID, String firstname, String lastname, int caregiverID) {
		this.employmentID = employmentID;
		this.firstname = firstname;
		this.lastname = lastname;
		this.caregiverID = caregiverID;
	}
	reviewData (int employmentID, int numberofstars, String comment) {
		this.employmentID = employmentID;
		this.numberofstars = numberofstars;
		this.comment = comment;
	}

	public static Vector<reviewData> getMyReviews(Connection connection, int clientID) {
...
public static Vector<reviewData> getCaregiverReviews(Connection connection, int caregiverID) {
        Vector<reviewData> vec = new Vector<reviewData>();
	...
	public static Vector<reviewData> getPendingReviews(Connection connection, int clientID) {
        Vector<reviewData> vec = new Vector<reviewData>();
	...
	public static int insertReview(Connection connection, reviewData review) {
